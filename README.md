# Olá, eu sou Vinícius de Souza Araújo 👋

⚡ **Estudante de Eletroeletrônica** | Sistemas Embarcados, Automação & Projetos  


---

### 👨‍💻 Sobre mim
Sou estudante do Ensino Médio integrado ao Técnico em Eletroeletrônica na ETEC Trajano Camargo.
Tenho interesse em automação industrial, sistemas embarcados e integração entre hardware e software.
Atualmente desenvolvo projetos e estudos envolvendo:
CLPs e programação Ladder
CODESYS
Factory I/O
ESP32 e microcontroladores
C/C++
Eletrônica e sistemas embarcados
AutoCAD e Autodesk Fusion
Meu objetivo é desenvolver uma base sólida em automação, mecatrônica e tecnologia industrial por meio de projetos práticos e documentação técnica.
